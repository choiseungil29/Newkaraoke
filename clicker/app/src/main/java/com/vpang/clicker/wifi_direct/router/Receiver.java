package com.vpang.clicker.wifi_direct.router;
...
public class Receiver implements Runnable {
     ...
     */
    static DataSendActivity activity;
//    static WiFiDirectActivity activity;
     ...
     * @param a
     */
    public Receiver(DataSendActivity a) {
        Receiver.activity = a;
        running = true;
    }
