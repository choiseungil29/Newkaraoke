package com.midisheetmusic.wifi_direct.router;
...
import com.midisheetmusic.wifi_direct.router.tcp.TcpReciever;
...
public class Receiver implements Runnable {
     ...
     */
    static AllSongsActivity activity;
     ...
     * @param a
     */
    public Receiver(AllSongsActivity a) {
        Receiver.activity = a;
        running = true;
    }
...
//                                    MessageActivity.addMessage(name, msg);
                                ...
                                //Todo 여기다가 받아올때 테이터를 처리
                                AllSongsActivity.setEditText(msg);
                            }
                        });
                        updatePeerList();
                    }
